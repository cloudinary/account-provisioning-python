...
## Table of Contents
<!-- $toc-max-depth=2 -->
* [Cloudinary Account Provisioning Python SDK](#cloudinary-account-provisioning-python-sdk)
...
* [Asynchronous Example](#asynchronous-example-2)
...
[`CloudinaryError`](./src/cloudinary_account_provisioning/models/cloudinaryerror.py) is the base class for all HTTP error responses. It has the following properties:
...
### Error Classes
**Primary error:**
* [`CloudinaryError`](./src/cloudinary_account_provisioning/models/cloudinaryerror.py): The base class for HTTP error responses.
...
**Inherit from [`CloudinaryError`](./src/cloudinary_account_provisioning/models/cloudinaryerror.py)**:
* [`ErrorResponse`](./src/cloudinary_account_provisioning/models/errorresponse.py): Bad request. Applicable to 26 of 47 methods.*
* [`PermissionsErrorResponse`](./src/cloudinary_account_provisioning/models/permissionserrorresponse.py): Applicable to 18 of 47 methods.*
* [`ResponseValidationError`](./src/cloudinary_account_provisioning/models/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
