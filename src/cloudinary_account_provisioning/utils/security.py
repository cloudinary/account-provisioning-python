...
def get_security_from_env(security: Any, security_class: Any) -> Optional[BaseModel]:
    ...
    if os.getenv("CLOUDINARY_PROVISIONING_API_KEY"):
        security_dict["provisioning_api_key"] = os.getenv(
            "CLOUDINARY_PROVISIONING_API_KEY"
        )

    if os.getenv("CLOUDINARY_PROVISIONING_API_SECRET"):
        security_dict["provisioning_api_secret"] = os.getenv(
